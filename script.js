  ...
  if (generatePdfBtn) {
    generatePdfBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        // Field: "Nome della struttura (pagina 1)"
        ...
        // Field: "Data generazione del preventivo"
        try {
        ...
        // Field: "Numero ambulatori inseriti"
        ...
        // Field: "Canone mensile predefinito (pagina 1)"
        try {
        ...
        // Field: "Canone mensile predefinito (pagina 2)"
        try {
        ...
        // Field: "Totale (canone + setup)"
        // This is the setup fee and should be filled only if discount applied (as per previous logic).
        try {
          if (window.calculatedOfferData.hasDiscountApplied) {
            ...
            form.getTextField('Quota_scontata').setText(''); // Leave empty if no discount
        ...
        // Field: "Canone mensile scontato (se applicabile)"
        // This should be the discounted monthly price.
        try {
